...
wspomina się o Hsp70 jako białku który pełni taką funkcję. Rzeczywiście, z uwagi na jego wiązanie się z czynnikiem transkrypcyjnym Hsf1
wpływa na transkrypcje białek odpowiedzi na szok cieplny, ale nie jest to oparte na własnej denaturacji i 
...
nie istnieją obecnie wyniki które by wskazywały na to jaki jest wkład zmiany prędkości metabolizmu
...
uniemożliwiające im dostosowanie się do nowych warunków i w rezultacie powodujące ich śmierć. Już teraz
...
Dane na temat zakresu odporności na temperaturę pobrałam z bazy danych BRENDA (http://www.brenda-enzymes.info/). 
